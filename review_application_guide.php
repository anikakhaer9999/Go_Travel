              ...
              <html lang="en">
                  ...
                  <body>
                    ...
                    <h1 class="header">
                      ...
                      <input id="button" type="button" value="All Member" onclick="allmembers();">
                      <input id="button" type="button" value="All Hotels" onclick="allhotels();">
                      <input id="button" type="button" value="Complaints" onclick="complaints();">
                      <input id="button" type="button" value="See Application" onclick="see_all_application();">
                      <input id="button" type="button" value="See Reviews" onclick="see_all_reviews()">
                              ...
                              <tbody>
                                  ...
                                  try{
                                      ...
                                      if($returnobj->rowCount()==0){
                                          ?>
                                              <tr>
                                                  <td colspan="8">No Application Available</td>
                                              <tr>
                                          <?php
                                      }
                                          ...
                                          foreach($returntable as $row){
                                              ...
                                              <tr>
                                                 ...
                                                 <td>
                                                    <img src="<?php echo $row['Image'] ?>" width="300" height="200">
                                                 </td>
                                                  ...
                                                  <td>
                                                      <img src="<?php echo $row['pv_Image'] ?>" width="300" height="200">
                                                  </td>
